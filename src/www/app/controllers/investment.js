...
InvestmentCtrl.$inject = ['Investment', 'Investor', '$routeParams', '$scope', '$mdDialog', '$mdToast', '$filter'];

function InvestmentCtrl(Investment, Investor, $routeParams, $scope, $mdDialog, $mdToast, $filter) {
    var vm = this;

    $scope.master.toolbar = {title: 'Prestamos otorgados', icon: 'content/img/business/money.svg'}
    vm.view = {
    ...
    function getInvestments() {
      ...
      vm.promise = Investment.getList(id, vm.query)
    ...
    function getTotal() {
      var id = $routeParams.associationId;
      Investment.getTotal(id, vm.query)
      .then(function(response) {
    ...
    function removeInvestment() {
      ...
      Investment.remove(assoc_id, inv_id)
      .then(function(response) {
        getInvestments();
        vm.selected = [];
      });
