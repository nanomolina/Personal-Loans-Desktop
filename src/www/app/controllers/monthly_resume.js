...
angular
  ...
  .controller('MonthlyResume', MonthlyResume);

MonthlyResume.$inject = ['Investment', '$routeParams', '$scope', '$locale', '$mdDialog', '$mdToast'];

function MonthlyResume(Investment, $routeParams, $scope, $locale, $mdDialog, $mdToast) {
    var vm = this;

    $scope.master.toolbar = {title: 'Planilla mensual para Amembe', icon: 'content/img/business/receipt.svg',}
    vm.view = {
